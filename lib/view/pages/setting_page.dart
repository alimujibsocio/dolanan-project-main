...
//     return Scaffold(
//       appBar: AppBar(title: const Text("Setting Page"), centerTitle: true),
//       body: const Center(
...
class SettingPage extends StatefulWidget {
  UserModel user;
  SettingPage(this.user, {Key? key}) : super(key: key);

  @override
  State<SettingPage> createState() => _SignUpPageState();
}

class _SignUpPageState extends State<SettingPage> {
  File? file;
  UploadTask? task;
